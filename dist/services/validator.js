/*
 * @FilePath: /website_checker/src/validator.ts
 * @author: Wibus
 * @Date: 2022-02-11 12:00:48
 * @LastEditors: Wibus
 * @LastEditTime: 2022-02-11 12:00:48
 * Coding With IU
 */
import { semver as joiSemver, semverRange as joiSemverRange, } from 'joi-extension-semver';
import joi from 'joi';
...
export const optionalDottedVersionNClausesWithOptionalSuffix = Joi.string().regex(/^\d+(\.\d+)*([-+].*)?$/);
